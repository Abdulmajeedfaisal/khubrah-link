    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <label for="remember_me" class="inline-flex items-center cursor-pointer">
                <input id="remember_me" type="checkbox" class="rounded border-gray-300 dark:border-slate-600 text-primary-600 shadow-sm focus:ring-primary-500 dark:bg-slate-700 dark:focus:ring-primary-600 dark:focus:ring-offset-slate-800" name="remember">
        ...
        <div class="text-center">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                ليس لديك حساب؟
                <a href="{{ route('register') }}" class="font-bold text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300 transition-colors">
                    سجل الآن مجاناً
                </a>
            </p>
        </div>
