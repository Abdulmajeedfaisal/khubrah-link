            ...
            <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex flex-wrap items-center gap-4 text-sm">
                                <div class="flex items-center gap-1">
                                    ...
                                    <span class="font-bold text-gray-900 dark:text-white">{{ number_format($skill->average_rating, 1) }}</span>
                                    <span class="text-gray-600 dark:text-gray-400">({{ $skill->reviews->count() }} تقييم)</span>
                                </div>
                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-6">
                    ...
                    @if($skill->reviews->count() > 0)
                        <!-- Rating Summary -->
                        <div class="bg-gray-50 dark:bg-slate-700/50 rounded-lg p-6 mb-6">
                        ...
                        <div class="text-center py-8">
                            ...
                            @auth
                                @if($skill->user_id !== auth()->id())
                                    <p class="text-sm text-gray-500 dark:text-gray-500 mt-2">كن أول من يقيم هذه المهارة</p>
                                @endif
                            @endauth
                        </div>
                    @endif
                            ...
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex items-center gap-1 text-sm text-gray-600 dark:text-gray-400">
                                        ...
                                        <span class="font-medium">{{ number_format($relatedSkill->average_rating, 1) }}</span>
                                    </div>
                                </div>
                            </div>
