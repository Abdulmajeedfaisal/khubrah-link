<footer class="bg-white dark:bg-slate-800 border-t border-gray-200 dark:border-slate-700 transition-colors duration-300">
        ...
        <div class="grid md:grid-cols-4 gap-8">
            ...
            <div class="space-y-4">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-xl font-bold text-gray-900 dark:text-white">خبرة لينك</span>
                </div>
                <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                    منصة مجتمعية لتبادل المهارات والخبرات بين الأفراد محلياً. علّم ما تجيده، تعلّم ما تحتاجه.
                </p>
                <div class="flex gap-3">
                    <a href="#" class="w-10 h-10 bg-gray-100 dark:bg-slate-700 hover:bg-primary-600 dark:hover:bg-primary-600 rounded-lg flex items-center justify-center transition-all duration-300 group">
            ...
            <!-- Contact -->
            <div>
                <h3 class="font-bold text-gray-900 dark:text-white mb-4">تواصل معنا</h3>
                <ul class="space-y-3">
                    <li class="flex items-start gap-2 text-sm text-gray-600 dark:text-gray-400">
                        <svg class="w-5 h-5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                        </svg>
                        <span>info@khubrahlink.com</span>
                    </li>
                    <li class="flex items-start gap-2 text-sm text-gray-600 dark:text-gray-400">
                        <svg class="w-5 h-5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
